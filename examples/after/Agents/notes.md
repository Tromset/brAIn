...
- **One single page**, simple, "like a pretty shop window"
- Colors: pink and cream ("like my cake boxes") — pink ≈ `#d96c8a`, color-picked from the box logo
...
- Photo gallery after the photo shoot
- Maybe an order form if she changes her mind
